...
import StaffSeatManagement from './StaffSeatManagement';
...
const EmployeeVacationStatus = ({ onUserClick }) => {
    ...
    const fetchVacations = async () => {
        setLoading(true);
        try {
            // 1. Fetch requests for the selected date (Existing Logic)
            let query = supabase
            ...
            // 2. Fetch Weekly Data for Limit Check (New Logic)
            // Calculate Start (Mon) and End (Sun) of the week for selectedDate
            ...
            // 3. Client-side Filter by Branch and Type (Existing Logic)
    ...
    return (
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '15px', alignContent: 'flex-start', height: '100%' }}>
            ...
            >
                ...
                <span style={{ fontSize: '0.85rem', fontWeight: 'bold', textAlign: 'center', lineHeight: '1.2' }}>좌석<br />관리</span>
            </button>
