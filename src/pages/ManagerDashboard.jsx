...
const StaffGridMenu = () => {
    const [currentView, setCurrentView] = useState('grid'); // 'grid', 'employee_vacation', 'work_status', 'vacation_request', 'seat_management'

    // Sub-views
    if (currentView === 'employee_vacation') {
        // ... (existing)
    }
    // ... (other existing sub-views)
    ...
    const handleMenuClick = (num) => {
        ...
        else if (num === 5) setCurrentView('seat_management'); // NEW
