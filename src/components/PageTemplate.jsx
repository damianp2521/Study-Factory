...
const PageTemplate = ({ title, content, children, backPath }) => {
    ...
    return (
        <div style={{ padding: 'var(--spacing-lg) var(--spacing-md)' }}>
            <div className="flex-center" style={{ justifyContent: 'flex-start', marginBottom: 'var(--spacing-lg)' }}>
                <button onClick={() => backPath ? navigate(backPath) : navigate(-1)} style={{ background: 'none', marginRight: 'var(--spacing-sm)' }}>
