-- Safe version (no DO blocks)

-- 1) Weekly work-plan master table
...
-- 3) Weekly work-plan activity log
...
DROP POLICY IF EXISTS weekly_work_plans_select_policy ON public.weekly_work_plans;
DROP POLICY IF EXISTS weekly_work_plans_insert_policy ON public.weekly_work_plans;
DROP POLICY IF EXISTS weekly_work_plans_update_policy ON public.weekly_work_plans;
DROP POLICY IF EXISTS weekly_work_plans_delete_policy ON public.weekly_work_plans;
...
DROP POLICY IF EXISTS weekly_work_plan_todos_select_policy ON public.weekly_work_plan_todos;
DROP POLICY IF EXISTS weekly_work_plan_todos_insert_policy ON public.weekly_work_plan_todos;
DROP POLICY IF EXISTS weekly_work_plan_todos_update_policy ON public.weekly_work_plan_todos;
DROP POLICY IF EXISTS weekly_work_plan_todos_delete_policy ON public.weekly_work_plan_todos;
...
DROP POLICY IF EXISTS weekly_work_plan_activity_logs_select_policy ON public.weekly_work_plan_activity_logs;
DROP POLICY IF EXISTS weekly_work_plan_activity_logs_insert_policy ON public.weekly_work_plan_activity_logs;
